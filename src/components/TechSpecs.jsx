...
export default function TechSpecs() {
  return (
    <section className="w-full bg-[#f0f2f5] px-8 mt-5 ">
  ...
  className="bg-white rounded-3xl p-8  md:row-span-2 flex flex-col min-h-[300px]"
>
  <span className="text-3xl mb-4 text-slate-500"><ImShield /></span>
...
>
  <span className="text-3xl mb-4 text-green-500"><FaLeaf/></span>
...
>
  <span className="text-3xl mb-4 text-green-500"><FaRecycle /></span>
...
<motion.div
  ...
  className="bg-blue-600 rounded-3xl p-8  flex flex-col justify-end min-h-[250px]"
>
  <span className="text-3xl mb-4 text-blue-200"><FaDroplet /></span>
